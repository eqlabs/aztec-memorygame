...
export async function compileNoirSource(noir_source: any) {
  await initNoirWasm();
...
export async function createProof(compiled_noir: any, circuitParams: any) {
...
export async function verifyProof(verifier: any, proof: any) {
